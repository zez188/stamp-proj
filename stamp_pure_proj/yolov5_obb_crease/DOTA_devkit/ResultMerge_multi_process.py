...
def parse_args():
    ...
    parser.add_argument('--scrpath', default='/data/ZGM/yolov5_obb/runs/detect/exp/labels', help='test config file path')
    parser.add_argument('--dstpath', default='/data/ZGM/yolov5_obb/runs/detect/merge', help='checkpoint file')
