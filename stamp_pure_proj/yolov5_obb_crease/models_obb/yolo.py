...
from models_obb.common import *
from models_obb.experimental import *
from utils_obb.autoanchor import check_anchor_order
from utils_obb.general import LOGGER, check_version, check_yaml, make_divisible, print_args
from utils_obb.plots import feature_visualization
from utils_obb.torch_utils import fuse_conv_and_bn, initialize_weights, model_info, scale_img, select_device, time_sync
...
if __name__ == '__main__':
    ...
    if opt.test:
        # 改
        for cfg in Path(ROOT / 'models_obb').rglob('yolo*.yaml'):
