...
from utils_obb.downloads import gsutil_getsize
from utils_obb.metrics import box_iou, fitness
pi = 3.141592
from utils_obb.nms_rotated import obb_nms
...
def check_file(file, suffix=''):
    ...
    if Path(file).is_file() or file == '':  # exists
        ...
        # 改
        for d in 'data', 'models_obb', 'utils_obb':  # search directories
