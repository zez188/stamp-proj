...
from utils_obb.general import LOGGER, colorstr, emojis
from utils_obb.rboxs_utils import pi, poly2rbox, regular_theta
import cv2
...
def kmean_anchors(dataset='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from utils_obb.datasets import LoadImagesAndLabels
