...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weight/best_m6_2000.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='company_test_sample', help='file/dir/URL/glob, 0 for webcam')
